...
public class AnagramsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            dictionary = new AnagramDictionary(new InputStreamReader(inputStream),isChecked);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(AnagramsActivity.this, "Helloo after 5 sec", Toast.LENGTH_SHORT).show();
            }
        },5000);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.findItem(R.id.two_letter);
    ...
    public boolean defaultAction(View view) {
        ...
        if (currentWord == null) {
            ...
            anagrams = dictionary.getAnagramsWithOneMoreLetter(currentWord,isChecked);
